...
int PlaceMarketOrderEx(char& [], int, double, char& [], int, int, int, double, double, double);
int PlaceLimitOrderEx(char& [], int, double, char& [], int, double, int, int, double, double, double);
int PlaceStopOrderEx(char& [], int, double, char& [], int, double, int, int, double, double);
int PlaceThresholdOrderEx(char& [], int, double, char& [], int, double, double, int, int, double, double);
...
enum EXEC_INST {
	...
	ExecInstHeld = 5,
	ExecInstParticipateDoNotInit   = 6,
	ExecInstStrictScale = 7,
	ExecInstTryToScale  = 8,
	ExecInstStayOnBidSide = 9,
	ExecInstStayOnOfferSide = 10,
	ExecInstNoCross = 11,
	ExecInstOKToCross = 12,
	ExecInstCallFirst   = 13,
	ExecInstPercentOfVolume = 14,
	ExecInstDoNotIncrease = 15,
	ExecInstDoNotReduce = 16,
	ExecInstAllOrNone = 17,
	ExecInstReinstateOnSystemFailure = 18,
	ExecInstInstitutionsOnly = 19,
	ExecInstReinstateOnTradingHalt = 20,
	ExecInstCancelOnTradingHalt = 21,
	ExecInstLastPeg = 22,
	ExecInstMidPricePeg = 23,
	ExecInstNonNegotiable = 24,
	ExecInstOpeningPeg = 25,
	ExecInstMarketPeg = 26,
	ExecInstCancelOnSystemFailure = 27,
	ExecInstPrimaryPeg = 28,
	ExecInstSuspend = 29,
	ExecInstFixedPegToLocalBestBidOrOfferAtTimeOfOrder = 30,
	ExecInstCustomerDisplayInstruction = 31,
	ExecInstNetting = 32,
	ExecInstPegToVWAP = 33,
	ExecInstTradeAlong = 34,
	ExecInstTryToStop = 35,
	ExecInstCancelIfNotBest = 36,
	ExecInstTrailingStopPeg = 37,
	ExecInstStrictLimit = 38,
	ExecInstIgnorePriceValidityChecks = 39,
	ExecInstPegToLimitPrice =   40,
	ExecInstWorkToTargetStrategy = 41,
	ExecInstPartialFill = 42,
};
