...
void demo2(){
   ...
   while(i < 100000){
      ...
      PlaceLimitOrderEx(account, BUY, 10000, symbol, SecurityTypeFOR, 1.0);
      Print("Call PlaceStopOrderEx...");
      PlaceStopOrderEx(account, BUY, 10000, symbol, SecurityTypeFOR, 1.2);
      Print("Call PlaceThresholdOrderEx...");
      PlaceThresholdOrderEx(account, BUY, 10000, symbol, SecurityTypeFOR, 1.2, 1.1);
      Sleep(100);  
      //i = i + 10000;
      i++;
   }
